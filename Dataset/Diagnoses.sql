...
SELECT
	...
	END AS patient_age -- if the patient is 18 years old and 10 months, he should be still considered as 18 years old to be able to get services. 
FROM
	diagnose
...
--) as T
--ORDER by episode_id ,age_patient